...
class attr extends Feature {
    ...
    public void infer_type(Map<AbstractSymbol, AbstractSymbol> objectEnv, ClassTable classTable, class_c curClass) {
        ...
        // if this attr is defined in an ancestor class
        if (classTable.getAncestorObjectEnv(curClass.name).containsKey(name)) {
...
class typcase extends Expression {
    ...
    public void infer_type(Map<AbstractSymbol, AbstractSymbol> objectEnv,
        ...
        Set<AbstractSymbol> branchTypeSet = new HashSet<AbstractSymbol>();
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (branchTypeSet.contains(true_branch_type)) {
...
abstract class int_op extends Expression {
    protected Expression e1;
    protected Expression e2;

    public int_op(int lineNumber) {
        super(lineNumber);
    }
...
class eq extends Expression {
    ...
    private boolean isBoolIntStr(Expression e) {
        return e.get_type() == TreeConstants.Bool ||
               e.get_type() == TreeConstants.Int  ||
               e.get_type() == TreeConstants.Str;
    }
}
